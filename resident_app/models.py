...
class Resident(models.Model):
    ...
    building = models.CharField(max_length=20, verbose_name='Строение', default='указать')
    entrance = models.CharField(max_length=50, verbose_name='Вход', default='указать')
